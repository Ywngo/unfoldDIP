...
from model.INR1D_Gabor import GaborLayer
from model.INR2D import make_coord_2d


class Gabor_INR2D(nn.Module):
    def __init__(self, dim, out_dim, hidden_dim=256, hidden_layers=2, use_pe=True, pe_dim=16):
        super().__init__()
        self.C_in = dim
        self.C_out = out_dim
        self.use_pe = use_pe
        self.pe_dim = pe_dim  # Gabor ����������������PE ����������������������������
        ...
        layers = []
        layers.append(GaborLayer(in_dim, hidden_dim, is_first=True, omega0=30.0))  # 2D ����������������
        for _ in range(hidden_layers):
            layers.append(GaborLayer(hidden_dim, hidden_dim, omega0=30.0))
